...
export default function OrdersManagementPage() {
  const orders = [
    { id: 'CMD-001', client: 'Jean Dupont', date: '2025-01-15 19:30', status: 'Livrée', amount: '€45.50', type: 'À emporter' },
    { id: 'CMD-002', client: 'Marie Curie', date: '2025-01-15 20:15', status: 'En préparation', amount: '€32.00', type: 'Sur place' },
    { id: 'CMD-003', client: 'Pierre Martin', date: '2025-01-15 12:45', status: 'En livraison', amount: '€56.80', type: 'Livraison' },
    { id: 'CMD-004', client: 'Sophie Laurent', date: '2025-01-14 18:20', status: 'Annulée', amount: '€28.50', type: 'Sur place' },
  ];
